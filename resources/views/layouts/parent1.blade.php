...
<head>
    ...
    <style>
        #mainnotification {
            max-height: 500px;
            /* set a custom maximum height */
            overflow-y: auto;
            /* add vertical scrollbar when necessary */
        }
    </style>
    @yield('css')
</head>
...
<body class="hold-transition sidebar-mini layout-fixed sidebar-closed sidebar-collapse">
    ...
    <a href="#" class="dropdown-item dropdown-footer">See All Messages</a>
                ...
                <li class="nav-item">
                    <a class="nav-link bg-danger" data-controlsidebar-slide="true" href="{{ route('logout') }}"
                        role="button"
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                                ...
                                <li class="nav-item">
                                    ...
                                    @if (session()->get('active') == 'users') {{ 'active' }} @endif ">
                                        ...
                                        <i class="far nav-icon"><img
                                                src="{{ asset('icons/users/list/' . $users_icon) }}" alt=""
                                                srcset=""></i>
                                        <p>{{ __('users_list') }}</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('user_add') }}"
                                     ...
                                     @if (session()->get('active') == 'user_add') {{ 'active' }} @endif">
                                        ...
                                        ?>
                                        <i class="far nav-icon"><img src="{{ asset('icons/users/add/' . $users_add) }}"
                                                alt="" srcset=""></i>
                                        <p>{{ __('users_add') }}</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('manage_index') }}"
                                        class="nav-link
                                    @if (session()->get('active') == 'manage_index') {{ 'active' }} @endif ">
                                        ...
                                        ?>
                                        <i class="far nav-icon"><img
                                                src="{{ asset('icons/users/delegates_rs/' . $delegates_rs) }}"
                                                alt="" srcset=""></i>
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('trackdelegates') }}"
                                     ...
                                     @if (session()->get('active') == 'trackdelegates') {{ 'active' }} @endif">
                                        ...
                                        ?>
                                        <i class="far nav-icon"><img
                                                src="{{ asset('icons/users/control_devices/' . $control_devices) }}"
                                                alt="" srcset=""></i>
                        ...
                        <li class="nav-item">
                            <a href="#"
                                class="nav-link
                            @if (session()->get('active') == 'listorderstate') {{ 'active' }}
                            @elseif (session()->get('active') == 'addorderstate')
                            {{ 'active' }}
                            @elseif(session()->get('active') == 'orders.delegates')
                            {{ 'active' }}
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('orders.delegates') }}"
                                        class="nav-link
                                            @if (session()->get('active') == 'orders.delegates') {{ 'active' }} @endif
                                            ">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>{{ __('orders.delegates') }}</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a href="#"
                                class="nav-link
                            @if (session()->get('active') == 'supplies_new') {{ 'active' }}
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('companies.filter') }}"
                                        class="nav-link
                                    @if (session()->get('active') == 'companies.filter') {{ 'active' }} @endif
                                    ">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>{{ __('companies.filter') }}</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('companies_supplies') }}"
                                        class="nav-link
                        ...
                        <li class="nav-item">
                            <a href="#"
                                class="nav-link
                            @if (session()->get('active') == 'add_personfin') {{ 'active' }}
                        ...
                        <li class="nav-item">
                            <a href="#"
                                class="nav-link
                            @if (session()->get('active') == 'orders_history') {{ 'active' }}
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('orders_added') }}"
                                        class="nav-link
                                    @if (session()->get('active') == 'orders_added') {{ 'active' }} @endif
                                    ">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>{{ __('orders_added') }}</p>
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('orders_deleted') }}"
                                        class="nav-link
                                    @if (session()->get('active') == 'orders_deleted') {{ 'active' }} @endif
                                    ">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>{{ __('orders_deleted') }}</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('orders_history') }}"
                                        class="nav-link
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('print_history') }}"
                                        class="nav-link
                                    @if (session()->get('active') == 'print_history') {{ 'active' }} @endif
                                    ">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>{{ __('print history') }}</p>
                                    </a>
                                </li>
                            </ul>
                        </li>
    ...
    <script>
        ...
        setInterval(function() {
            $.ajax({
                type: "GET",
                url: 'https://spear.zenonsoftware.com/notifications',
                dataType: "json",
                success: function(data) {
                    ...
                    data.notifications.forEach(function(notify) {
                        var notificationId = 'id-' + notify.id;
                        var existingNotification = document.querySelector(
                            '#mainnotification #' + notificationId);

                        if (existingNotification) {
                            // Notification exists, update its content
                            existingNotification.innerHTML =
                                '<i class="fas fa-envelope mr-2"></i>' + notify.title + '<br>' +
                                notify.data + '<span class="float-right text-muted text-sm">' +
                                notify.created_at_date + '<br>' + notify.created_at_time +
                                '</span>';
                        } else {
                            // Notification doesn't exist, add it
                            var newNotification = document.createElement('a');
                            newNotification.href =
                                '{{ route('orderscompantnotdeliver', ['param' => ':param']) }}'
                                .replace(':param', notify.company_id);
                            newNotification.id = notificationId;
                            newNotification.className = 'dropdown-item';
                            newNotification.innerHTML = '<i class="fas fa-envelope mr-2"></i>' +
                                notify.title + '<br>' + notify.data +
                                '<span class="float-right text-muted text-sm">' + notify
                                .created_at_date + '<br>' + notify.created_at_time + '</span>';

                            document.getElementById('mainnotification').appendChild(
                                newNotification);
                        }
                    });

                    // Check if any notifications were deleted
                    var notificationIds = data.notifications.map(function(notify) {
                        return 'id-' + notify.id;
                    });

                    var existingNotifications = document.querySelectorAll(
                        '#mainnotification a.dropdown-item');
                    existingNotifications.forEach(function(notification) {
                        var notificationId = notification.id;

                        if (!notificationIds.includes(notificationId)) {
                            // Notification was deleted, remove it
                            notification.remove();
                        }
                    });
                }
        ...
        channel.bind('OrderUpdate', function(data) {
            var notificationLink = '{{ route('orderscompantnotdeliver', ['param' => ':param']) }}'.replace(
                ':param', data.company_id);
            var notification = '<div class="dropdown-divider"></div><a href="' + notificationLink + '" id="id-' +
                data.id + '" class="dropdown-item"><i class="fas fa-envelope mr-2"></i>' + data.title + '<br>' +
                data.data + '<span class="float-right text-muted text-sm">' + data.created_at_date + '<br>' + data
                .created_at_time + '</span></a>';

            $('#mainnotification').append(notification);

            var counter = parseInt($('#countermain').text()) + 1;
            $('#countermain').text(counter);
            $('#counterin').text(counter + ' Notifications');
        ...
        function read() {
            ...
            $.ajax({
                url: 'https://spear.zenonsoftware.com/notifications/read',
                type: 'POST',
