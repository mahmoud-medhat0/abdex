...
<div class="col">
    <div class="form-group" data-select2-id="">
        ...
        <select name="delegates" id="delegates" class="form-control select2bs4 select2-hidden-accessible"
            ...
            <option value="" disabled selected>{{ __("delegate_change") }}</option>
            @isset($id)
                @foreach ($delegates as $delegate)
                    <option {{ $id == $delegate->id ? 'selected' : '' }} value="{{ $delegate->id }}">{{ $delegate->name }}</option>
                @endforeach
            @endisset
            @foreach ($delegates as $delegate)
        ...
        @enderror
        <button id="submitBtn" class="btn btn-block btn-success">{{ __("exec") }}</button>
    </div>
</div>
</div>
        ...
        <div class="col">
            <div class="form-group" data-select2-id="">
                ...
                @error('states')
                    <div class="text-danger font-weight-bold">*{{ $message }}</div>
                @enderror
                <button type="button" onclick="stateFunction()" class="btn btn-block btn-success">{{ __("exec") }}</button>
            </div>
        </div>
        <div class="col">
            <div class="form-group" data-select2-id="">
                ...
                <button type="button" onclick="causeFunction()" class="btn btn-block btn-success">{{ __("exec") }}</button>
            </div>
        </div>
        <div class="col">
            <div class="form-group" data-select2-id="">
                ...
                <button type="button" onclick="locateFunction()" class="btn btn-block btn-success">{{ __("exec") }}</button>
            </div>
        </div>
        <div class="col">
            <div class="form-group" data-select2-id="">
                ...
                <button type="button" onclick="centerFunction()" class="btn btn-block btn-success">{{ __("exec") }}</button>
            </div>
        </div>
        <div class="col">
            <div class="form-group" data-select2-id="">
                ...
                <button type="button" onclick="destroyFunction()" class="btn btn-block btn-success">{{ __("exec") }}</button>
            </div>
        </div>
    </div>
</div>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody id="tableBody">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $order->delegate_delivered ? Carbon::parse($order->delegate_delivered)->format('d-m-Y'): 'null' }}</td>
                                        <td>
...
<script>
    document.getElementById('submitBtn').addEventListener('click', function(event) {
        var selectedValue = document.getElementById('delegates').value;
        if (!selectedValue) {
            event.preventDefault(); // Prevent form submission
        } else {
            var url = "{{ route('accountant.delegates.search', ':selectedValue') }}";
