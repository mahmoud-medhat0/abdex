        ...
        <div class="row">
            <div class="col">
                <div class="form-group" data-select2-id="">
                    ...
                    <select class="form-control select2bs4 select2-hidden-accessible" id="company" style="width: 100%;"
                        aria-hidden="true">
                    ...
                    @enderror
                    <button type="button" onclick="company()" class="btn btn-block btn-success">{{ __("exec") }}</button>
                </div>
            </div>
            <div class="col">
                <div class="form-group" data-select2-id="">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{ route('print_historyc',$order->id) }}" class="btn btn-info btn-sm">{{ DB::table('print_history')->where('order_id', $order->id)->count() }}</a></td>
                                        <td>
                                            @foreach ($companies as $company)
